...
-- -----------------------------------------------------
-- Table `mundofesteirobd2`.`faces`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mundofesteirobd2`.`faces` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `mundofesteirobd2`.`chamada`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mundofesteirobd2`.`chamada` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `prestador_has_evento_id` INT NOT NULL,
  `prestador_has_evento_prestador_id` INT NOT NULL,
  `prestador_has_evento_evento_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_chamada_prestador_has_evento1_idx` (`prestador_has_evento_id` ASC, `prestador_has_evento_prestador_id` ASC, `prestador_has_evento_evento_id` ASC) VISIBLE,
  CONSTRAINT `fk_chamada_prestador_has_evento1`
    FOREIGN KEY (`prestador_has_evento_id` , `prestador_has_evento_prestador_id` , `prestador_has_evento_evento_id`)
    REFERENCES `mundofesteirobd2`.`prestador_has_evento` (`id` , `prestador_id` , `evento_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
